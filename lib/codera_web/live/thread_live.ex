defmodule CoderaWeb.ThreadLive do
  ...
  def render(%{live_action: :show} = assigns) do
    ~H"""
    <div class="w-full px-4 pb-15 flex flex-col h-screen">
      <!-- Header: sticky at the top -->
      <div class="sticky w-5xl mx-auto mt-2 bg-white pt-4 pb-2 px-5 mb-1 shadow-md">
      ...
      <!-- Messages: scrollable -->
      <div id="messages" class="w-full overflow-y-auto">
        <div class="flex-1 w-5xl mx-auto mt-2 flex flex-col space-y-4 mb-8 px-1 pb-20 pt-4">
      ...
      <div class="max-w-5xl w-full h-18 fixed left-1/2 transform -translate-x-1/2 bg-white border shadow-md border-gray-200 p-3 rounded-lg bottom-15">
        <.form for={%{}} as={:message} phx-submit="send_message" class="flex gap-2 h-full w-full items-center" id="message-form">
          <input
          type="text"
          name="message[content]"
          placeholder="Type your message..."
          class="flex-1 input input-bordered text-lg p-3 h-full"
          autocomplete="off"
          id="message-input"
          autofocus
          />
