defmodule Codera.AI.Configs.CodingAgent do
  ...
  def config do
    ...
    %{
      chain: LLMChain.new!(%{llm: model}) |> LLMChain.add_message(amp_system_prompt()),
      name: "test"
    }
  end

  def amp_system_prompt() do
    """
    ...
    Not surprising the user with actions you take without asking (for example, if the user asks you how to approach something or how to plan something, you should do your best to answer their question first, and not immediately jump into taking actions)
    ...
    When asked about Amp (e.g., your models, pricing, features, configuration, or capabilities), use the read_web_page tool to check https://ampcode.com/manual for current information.
